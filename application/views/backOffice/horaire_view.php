...
<body>
    ...
    <?php if (isset($horaire)): ?>
        ...
        <form action="<?php echo site_url('backOffice/HoraireController/updateDebut'); ?>" method="post">
            <label for="debut">Début:</label>
            <input type="time" name="debut" value="<?php echo $horaire['debut']; ?>" required>
            <button type="submit">Mettre à jour</button>
        </form>

        <form action="<?php echo site_url('backOffice/HoraireController/updateFin'); ?>" method="post">
            <label for="fin">Fin:</label>
            <input type="time" name="fin" value="<?php echo $horaire['fin']; ?>" required>
            <button type="submit">Mettre à jour</button>
        </form>

        <form action="<?php echo site_url('backOffice/HoraireController/updateDateReference'); ?>" method="post">
