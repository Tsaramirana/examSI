    ...
    <div class="row col-md-12" id="navbar">
        ...
        <div class="col-md-5" id="nav-bar-buttons">
            <ul class="nav nav-pills">
                ...
                <li role="presentation" class="emphase">
                    <a href="<?php echo site_url('Back/to_login_page'); ?>">Administrateur</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="row col-md-12" id="content">
        ...
        <div class="col-md-6" id="left">
            ...
            <div class="row col-md-12" id="content-button">
                <a href="<?php echo site_url('Front/to_login_page'); ?>" class="btn btn-default action-button">Prendre rendez-vous</a>
            </div>
        ...
        <div class="col-md-6" id="right">
            <div class="row col-md-12">
                <img src="<?php echo base_url('assets/images/index-right.png'); ?>" alt="" id="image-right">
            </div>
        </div>
        <!-- RIGHT -->
    </div>
